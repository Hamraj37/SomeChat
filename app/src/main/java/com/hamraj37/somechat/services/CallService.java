...
public class CallService extends Service {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot callerSnapshot : snapshot.getChildren()) {
                    ...
                    if ("calling".equals(status)) {
                        ...
                        Intent broadcastIntent = new Intent("com.hamraj37.somechat.INCOMING_CALL");
                    ...
                    if (message != null && message.getReceiverId().equals(myUid) && !message.isSeen()) {
                        ...
                        if (!friendUid.equals(ChatActivity.openedChatId)) {
                            ...
                            if (type == null || "text".equals(type)) {
                                notificationText = com.hamraj37.somechat.utils.EncryptionManager.decrypt(message.getText(), CallService.this, false);
                            } else {
    ...
    private void showMessageNotification(String senderId, String senderName, String text) {
        ...
        // Send In-App broadcast
        Intent broadcastIntent = new Intent("com.hamraj37.somechat.NEW_MESSAGE");
        broadcastIntent.setPackage(getPackageName());
    ...
    private void createNotificationChannels() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            callChannel.setVibrationPattern(new long[]{100, 200, 300, 400, 500, 400, 300, 200, 400});
