...
public class VideoCallService extends Service {
    ...
    private static final String SERVICE_CHANNEL_ID = "VideoCallServiceChannel";
    
    public static final String ACTION_ANSWER = "com.hamraj37.somechat.VIDEO_ACTION_ANSWER";
    public static final String ACTION_DECLINE = "com.hamraj37.somechat.VIDEO_ACTION_DECLINE";
    ...
    private void setupCallHandler() {
        ...
        callHandler.startListening(true); // Filter for video only
    }
    ...
    private void startForegroundNotification() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.UPSIDE_DOWN_CAKE) {
            startForeground(2, notification, ServiceInfo.FOREGROUND_SERVICE_TYPE_PHONE_CALL | ServiceInfo.FOREGROUND_SERVICE_TYPE_CAMERA);
        } else {
    ...
    private void notifyIncomingCall(String callerId, String name, String avatar) {
        ...
        Intent broadcastIntent = new Intent("com.hamraj37.somechat.VIDEO_INCOMING_CALL");
        ...
        broadcastIntent.putExtra("isVideo", true);
    ...
    private void showCallNotification(String callerId, String name, String avatar) {
        ...
        Intent answerIntent = new Intent(this, VideoCallService.class);
        ...
        Intent declineIntent = new Intent(this, VideoCallService.class);
        ...
        Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .addAction(R.drawable.ic_camera_black_24dp, "Answer", answerPI)
    ...
    private void createNotificationChannels() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel callChannel = new NotificationChannel(CHANNEL_ID, "Video Calls", NotificationManager.IMPORTANCE_HIGH);
            ...
            manager.createNotificationChannel(new NotificationChannel(SERVICE_CHANNEL_ID, "Video Call Service", NotificationManager.IMPORTANCE_MIN));
        }
    }
